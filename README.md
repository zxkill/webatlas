...
- Для аудита всех доменов и лимитированного аудита поддерживаются позиционные аргументы, kwargs и заголовки, что устраняет ошибки при разном наборе параметров.
