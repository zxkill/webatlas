...
- UI передаёт параметры задач через именованные аргументы, что упрощает совместимость при обновлениях.
- Задачи также поддерживают позиционные аргументы для безопасной обратной совместимости.
